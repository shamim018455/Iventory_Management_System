    ...
    <body ng-controller="appCtrl">
        ...
        <div class="container">
            ...
            <div class="col-md-12 header">
                <h1 align="center"><a href="<%= request.getContextPath()%>/"> Inventory</a></h1>
            </div>
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button  type="button" onclick="window.print()" class="btn btn-warning" ><i class="fa fa-print"></i> Print</button>
